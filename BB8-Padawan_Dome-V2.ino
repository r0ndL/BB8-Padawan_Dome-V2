...
#define BOARDtype 4 // 1 = Arduino Pro Mini or Uno or Duemilanove
...
void loop() {
    ...
    if(ET.receiveData()){
    //soundNumber=domeData.snd; // Sound number to play
    ...
    //{
        ...
        if(domeData.sndRDM == 1){
            if(!myPlayer.isBusy()){
                myPlayer.playFile(random(13,17));
                delay(100);
            }
        }

        if(domeData.sndRDM == 2){
            if(!myPlayer.isBusy()){
                myPlayer.playFile(random(17,25));
                delay(100);
            }
        }

        if(domeData.sndRDM == 3){
            if(!myPlayer.isBusy()){
                myPlayer.playFile(random(32,52));
                delay(100);
            }
        }

        if(domeData.sndRDM == 4){
            if(!myPlayer.isBusy()){
                myPlayer.playFile(random(25,32));
                delay(100);
            }
        }
